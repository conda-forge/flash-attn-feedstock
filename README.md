...
pixi add flash-attn flash-attn-fused-dense flash-attn-layer-norm
# for installing globally
pixi global install flash-attn flash-attn-fused-dense flash-attn-layer-norm
```
...
It is possible to list all of the versions of `flash-attn` available on your platform:
...
```
pixi search flash-attn --channel conda-forge
```
